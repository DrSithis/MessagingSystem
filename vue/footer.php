                ...
                <tr>
                    <td class="w640" width="640">
                        <table id="footer" class="w640" bgcolor="#322d4d" border="0" cellpadding="0" cellspacing="0" width="640">
                            <tbody><tr><td class="w30" width="30"></td><td class="w580 h0" height="30" width="360"></td><td class="w0" width="60"></td><td class="w0" width="160"></td><td class="w30" width="30"></td></tr>
                                <tr>
                                    ...
                                    <td class="w580" valign="top" width="360">
                                        ...
                                        <p class="footer-content-left" align="left"><preferences lang="fr-FR">Modifier mon abonnement</preferences> | <unsubscribe>Se d&eacute;sinscrire</unsubscribe></p>
                    </td>
